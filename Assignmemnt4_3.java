 ...
 * @author LENOVO
 */
public class Assignmemnt4_3 extends javax.swing.JFrame {

    /**
     * Creates new form UnitConverterFrame
     */
    public Assignmemnt4_3() {
        initComponents();
    ...
    private void jrbMeterActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void jrbCentimeterActionPerformed(java.awt.event.ActionEvent evt) {
        String s=txtIn.getText().trim();
        try{
            int km=Integer.parseInt(s);
            long result=0;
    ...
    private void jrbMilimeterActionPerformed(java.awt.event.ActionEvent evt) {
        String s=txtIn.getText().trim();
        try{
            int km=Integer.parseInt(s);
            long result=0;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Assignmemnt4_3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Assignmemnt4_3().setVisible(true);
            }
        });
    }
